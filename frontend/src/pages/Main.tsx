import CryptoStats from "../compoents/crypto-card";
function Main() {
  return (
    <>
            ...
            <div>
              <div className="mt-4 md:mb-12 max-w-2xl">
                ...
                <p className="text-gray-600">
                  The course is designed for frontend engineers who want to learn AWS. The content does not require deep
                  knowledge of backend or DevOps. You will learn how to host, secure, and scale your applications using
                  the most popular AWS services - S3, CloudFront, Cognito, Lambda, and more.
                </p>
              </div>
              <blockquote className="hidden md:block relative max-w-sm">
                ...
                <div className="relative z-10">
                  <p className="text-xl italic text-gray-800">Start using AWS easily.</p>
                </div>
                ...
                <footer className="mt-3">
                  <div className="flex items-center gap-x-4">
                    ...
                    <div className="grow">
                      ...
                      <div className="text-xs text-gray-500">DevOps | AnyInc</div>
                    </div>
                  </div>
                </footer>
              </blockquote>
                  ...
                  autofill:pb-2"
                    ...
                    peer-not-placeholder-shown:text-gray-500"
                      ...
                      "mode": "popover"
                            ...
                            <h4 className="mt-3 text-sm font-semibold text-gray-800">Your password must contain:</h4>
